...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2017 at 03:55 PM
...
CREATE TABLE IF NOT EXISTS `patient_tab` (
...
CREATE TABLE IF NOT EXISTS `report_tab` (
  `code_no` varchar(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `test_table` (
  `SL_No` int(25) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `test_table` (`SL_No`, `Test Name`, `Status`) VALUES
(1, 'ECG', 'yes'),
(2, 'Creatine', 'No'),
(3, 'CBC', 'yes'),
(4, 'CT Scan', 'No'),
