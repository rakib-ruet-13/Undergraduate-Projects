	...
	<div class = "fix mainmanu">
		...
		<?php
			if($_SESSION['page']=="")
		 		...
		 		echo '<li><a href="../front_page/rmc_front_page">Home</a></li>';
		 	...
		 	if($_SESSION['page']=='helpsupport')
		 		echo '<li class="active"><a href="index.php">Help & Support</a></li>';
		 	else
		 		echo '<li><a href="index.php">Help & Support</a></li>';


		 	if($_SESSION['admin_id']=="" && $_SESSION['page']=='admin')
		 		echo '<li class="active"><a href="../rmcenter/rmc_admin_login.php">Administration</a></li>';
		 	else
