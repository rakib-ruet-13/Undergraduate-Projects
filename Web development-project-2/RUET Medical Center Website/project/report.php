...
<p style="text-align:center;"> <a href="../project/new1.php" style="text-decoration:none; color: white; font-size:17px; text-align:center "> <button type="button" class="btn btn-primary"> Create Patient Report </button> </a>   <a href="../project/delete.php" style="text-decoration:none; color: white; font-size:17px; text-align:center "> <button type="button" class="btn btn-primary">Delete report</button></a>
 </p>
