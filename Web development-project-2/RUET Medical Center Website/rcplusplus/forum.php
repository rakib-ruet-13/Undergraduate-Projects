...
?>
      ...
      <?php
      if($flag==1)
                     echo "<a href=/rcplusplus/homepage.php>log_in </a> first. or no input";
      ?>
     ...
     $db="project";
               ...
               $reslt=$conn->query($sql);
                 ...
                 if($reslt->num_rows > 0 )
                {
                    ...
                    {
                           echo "<p style='text-align:left;border: 1px solid black; padding:10px; color:black;'>";
                          ...
                          echo "<br>REPLY:<br>";
                           ...
                           else
                           {
                            ...
                            echo "<a  href='/rcplusplus/reply_1.php?comment_no=$comm_no' style='text-decoration:none'> reply here</a>";
