...
<div class="main" style="color: rgb(0,0,0);">
      ...
      if($flag==3)
      {
           ...
           else
           {
             ...
             $sql="select serial_no,pin_no,status,chief from pincode where pin_no='$pincode' and status='unused' and chief='yes'";

             $reslt_new=$conn->query($sql);

             
            if($reslt_new->num_rows > 0 )
            {
                
                 $sql="insert into chief VALUES ('$username')";
                 $conn->query($sql);
             ...
             if($reslt->num_rows > 0 )
               ...
               $sql="insert into rmc_admin VALUES ('$username','$password')";
                ...
                echo "The pin you used is invalid pin from now<br>";
