...
<div class="main">
    ...
    <div class="menu" style="font-size:15px; width:100%;">
      ...
      <ul >
           ...
           <li ><a style="color:white" href="../rmcenter_admin/rmc_student_profile_show.php">Search Students</a></li>
      
        
        <li><a style="color:white" href="../rmcenter_admin/rmc_student_info_create.php">Create student Profile</a></li>
