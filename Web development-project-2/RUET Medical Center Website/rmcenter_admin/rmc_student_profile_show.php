...
<div class="main">
 ...
 // just so we know it is broken
    $conn = new mysqli($servername, $user, $pass,$db);
     ...
     $sql = "SELECT image FROM student_image WHERE roll='$roll';";
...
?>
    ...
    <div class="info" style='float:right;width:50%;color :white;padding-right:0px;font-size: 20px; line-height: 30px;'>
     ...
     <button type="button" class="btn btn-danger"> <h4 style='color:white ; padding:2px;'>STUDENT INFORMATION</h4></button>
     <br>
    ...
    <?php
     ...
     $conn = new mysqli($servername, $user, $pass,$db);
      ...
      $sql="select name,roll,blood,dob,contact from student_profile where roll='$roll'";
