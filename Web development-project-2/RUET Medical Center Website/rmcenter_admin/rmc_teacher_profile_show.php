...
<div class="main">
 ...
 // just so we know it is broken
    $conn = new mysqli($servername, $user, $pass,$db);
     ...
     $sql = "SELECT image FROM teacher_image WHERE id='$roll';";
...
?>
    ...
    <div class="info" style='float:right;width:50%;color :white;padding-right:0px;font-size: 20px; line-height: 30px;'>
        ...
        <button type="button" class="btn btn-danger"> <h4 style='color:white ; padding:2px;'>TEACHER INFORMATION:</h4></button>
     <br>
    ...
    <?php
     ...
     $conn = new mysqli($servername, $user, $pass,$db);
      ...
      $sql="select name,id,blood,dob,contact from teacher_profile where id='$roll'";
