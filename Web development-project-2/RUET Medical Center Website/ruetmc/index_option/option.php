		...
		<?php
			if($_SESSION['page']=="")
		 	...
		 	if($_SESSION['page']=='about') 
		 	 	echo '<li class ="active" style="color: rgb(102,41,26)"><a href="../user_page/about.php">About</a></li>';
		 	else
		 		echo '<li><a href="../user_page/about.php">About</a></li>';

		 	if($_SESSION['page']=='contact')
		 		echo '<li class="active" style="color: rgb(102,41,26)"><a href="../user_page/contact.php">Contact Us</a></li>';
		 	else
		 		echo '<li><a href="../user_page/contact.php">Contact Us</a></li>';

		 	if($_SESSION['page']=='helpsupport')
		 		echo '<li class="active" style="color: rgb(102,41,26)"><a href="../user_page/helpsupport.php">Help & Support</a></li>';
		 	else
		 		echo '<li><a href="../user_page/helpsupport.php">Help & Support</a></li>';


		 	if( $_SESSION['page']=='admin')
		 		echo '<li class="active" style="color: rgb(102,41,26)"><a href="../rmcenter_admin/rmc_admin_login.php">Administration</a></li>';
		 	else
		 		echo '<li style="color: rgb(102,41,26)"><a href="../rmcenter_admin/rmc_admin_login.php">Administration</a></li>';
