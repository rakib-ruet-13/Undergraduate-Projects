...
<button type="button" class="btn btn-success"><a style="color: white; font-size:16px; float:center; text-decoration:none; padding:25px; align:center;" href="edit_new.php" class="button">Insert new test</a></button>
</div>
</html>
<html>
<head>
