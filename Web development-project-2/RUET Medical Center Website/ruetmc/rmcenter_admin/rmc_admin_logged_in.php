    ...
    <div class="menu" style="font-size:15px; color:white ; align: center; width:100%;"  >
      ...
      <ul >
        ...
        <li><a style="color:white" href="../rmcenter_admin/rmc_teacher_options.php">Teachers</a></li>
         <li><a style="color:white" href="../test/test_option.php">Create test report </a></li>
          <li><a style="color:white" href="../test/prescription.php">Create prescription </a></li>
       
        <li><a style="color:white" href="../project/option_equip.php">Edit Equipmental Status</a></li>
        <li><a style="color:white" href="../rmc/home.php">Ambulance Schedule</a></li>
        <li><a style="color:white" href="../rmcenter_admin/schedule.php">Doctors schedule</a></li>
      </ul>
     </div>
