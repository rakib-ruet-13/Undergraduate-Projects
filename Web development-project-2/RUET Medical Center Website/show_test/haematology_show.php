...
function test_input($data) {
  ...
  return $data;
              ...
              $conn = new mysqli($servername, $user, $pass,$db);
               ...
               $sql="select * from haematology where patient_role='$patient_role' and id='$id'  order by serial_no desc; ";
      ...
      echo " <td>Hemoglobin: </td>  <td>$hemo </td> <td> M=13.18 gm/dl / F=11.5-16.5 gm/dl</td> 
        ...
        <td>   E.S.R:</td> <td> $esr</td> <td> M=0.10 mm in 1st hr / F=0.12 mm in 1st hr</td> 
         ...
         echo ' </div>';
           ...
           $test_name='haematology';

            echo "<a style='color:white;text-decoration:none;' href='../show_test/haematology_delete.php? id=$row[serial_no]&test=$test_name'>";
            ...
            echo " </a>";
             ...
             echo "&nbsp"; echo "&nbsp";
              ...
              echo "<a style='color:white;text-decoration:none;' href='../show_test/print_haematology.php? id=$row[serial_no]' >";
