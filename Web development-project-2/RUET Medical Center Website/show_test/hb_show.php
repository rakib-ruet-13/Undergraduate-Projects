  ...
  return $data;
     ...
     $patient_role= $_SESSION["ptype"] ;
              ...
              $conn = new mysqli($servername, $user, $pass,$db);
               ...
               $sql="select * from hb where patient_role='$patient_role' and id='$id'  order by serial_no desc; ";
         ...
         <td>  2 hrs after 75 gram glucose:</td> <td>     $glu      </td> <td> (Coresponding urine sugar): 8.8.0 mmol/L</td>
          ...
          <td> </td><td>        </td> <td> </td> 
           ...
           $test_name='hb';
            ...
            echo "<a style='color:white;text-decoration:none;' href='../show_test/hb_delete.php? id=$row[serial_no]&test=$test_name'>";
            ...
            echo " </a>";
             ...
             echo "&nbsp"; echo "&nbsp";
              ...
              echo "<a style='color:white;text-decoration:none;' href='../show_test/print_hb.php? id=$row[serial_no]' >";
