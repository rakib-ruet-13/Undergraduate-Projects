  ...
  return $data;
     ...
     $patient_role= $_SESSION["ptype"];
              ...
              $conn = new mysqli($servername, $user, $pass,$db);
               ...
               $sql="select * from prescription where patient_role='$patient_role' and id='$id'  order by serial_no desc; ";
...
echo '
<div style="color: black; float:center; margin-bottom:20px;">
       ...
       <td>$md8 </td>
         <td>$qty8</td>
          ...
          echo "<div style=' color: red;'>";
                      ...
                      $test_name='prescription';

                     
                        echo "<br>";

                      echo "<a style='color:red ; font-size: 20px; padding-top: 10px; text-decoration:none;' href='../show_test/prescription_delete.php? id=$row[serial_no]&test=$test_name'>";
                      ...
                      echo " </a>";
                       ...
                       echo "&nbsp"; echo "&nbsp";
                        ...
                        echo "<a style='color:red ; font-size: 20px; padding: 10px; text-decoration:none;' href='../show_test/print_prescription.php? id=$row[serial_no]' >";
