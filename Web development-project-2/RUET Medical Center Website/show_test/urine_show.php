...
function test_input($data) {
  ...
  return $data;
              ...
              $conn = new mysqli($servername, $user, $pass,$db);
               ...
               $sql="select * from urine where patient_role='$patient_role' and id='$id'  order by serial_no desc; ";
 ...
 <tr>
          <td> Epithelial cells</td> <td>  $ep     </td> <td></td>
           ...
           $test_name='urine';
            ...
            echo "<a style='color:white;text-decoration:none;' href='../show_test/urine_delete.php? id=$row[serial_no]&test=$test_name'>";
            ...
            echo " </a>";
             ...
             echo "&nbsp"; echo "&nbsp";
              ...
              echo "<a style='color:white;text-decoration:none;' href='../show_test/print_urine.php? id=$row[serial_no]' >";
