...
<div class="main" style="float: center;"">
    ...
    <div class="menu" style="font-size:15px; color:white ; align: center; width:100%;"  >
      ...
      <ul >
         ...
         <li><a style="color:white" href="../test/haematology.php">Create Haematology report </a></li>
          <li><a style="color:white" href="../test/urine.php">Create urine report</a></li>
           <li><a style="color:white" href="../test/serology.php">Create serology report</a></li>
            <li><a style="color:white" href="../test/stool.php">Create Stool examination report</a></li>
              <li><a style="color:white" href="../test/hb.php">Create haematology & biochemical analysis report </a></li>
