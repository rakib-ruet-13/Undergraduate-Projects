...
<div class="main" style="float: center;"">
    ...
    <div class="menu" style="font-size:15px; color:white ; align: center; width:100%;"  >
      ...
      <li><a style="color:white" href="../test/prescription.php">Create new Prescription </a></li>
          <li><a style="color:white" href="../test/prescription_form.php"> Search recorded Prescriptions </a></li>
