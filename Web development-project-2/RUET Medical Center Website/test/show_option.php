...
<div class="main" style="float: center;"">
    ...
    <div class="menu" style="font-size:15px; color:white ; align: center; width:100%;"  >
      ...
      <li><a style="color:white" href="../show_test/haematology_show.php"> Haematology </a></li>
      <li><a style="color:white" href="../show_test/serology_show.php"> Serology </a></li>
      <li><a style="color:white" href="../show_test/urine_show.php"> Urine </a></li>
      <li><a style="color:white" href="../show_test/stool_show.php"> Stool</a></li>
      <li><a style="color:white" href="../show_test/hb_show.php"> Haematology & Biochemical Examination</a></li>
