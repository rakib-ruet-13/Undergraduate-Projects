            ...
            //last 10 comments
               ...
               $cnt1=0;
                ...
                $cnt2=0;
                 ...
                 $sql2="select * from user_quiz where user_id='$user_id' and quiz_id=$q_id";
              ...
              // echo "$cnt1   and $cnt2 <br>";
                ...
                for( $i=1; $i<=$cnt1 && $cnt2==0 ; $i++)
                {
                  ...
                  $sql="select quiz.quiz_id,quiz.ques_id,ques,ans1,ans2,ans3,ans4,actual from quiz,user_quiz where user_quiz.user_id='$user_id' and quiz.quiz_id=$q_id and flag=0";
